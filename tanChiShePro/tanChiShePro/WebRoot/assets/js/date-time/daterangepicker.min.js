!function(b) {
	var a = function(k, s, i) {
		...
		var d = '<div class="daterangepicker dropdown-menu"><div class="calendar left"></div><div class="calendar right"></div><div class="ranges"><div class="range_inputs"><div class="daterangepicker_start_input" style="float: left;width: 100%;"><label for="daterangepicker_start">'
				+ this.locale.fromLabel
				+ '</label><input class="input-mini" type="text" name="daterangepicker_start" style="width:80%" value="" disabled="disabled" /></div><br/><br/><div class="daterangepicker_end_input" style="float: left; clear:both;width: 100%;"><label for="daterangepicker_end">'
				+ this.locale.toLabel
				+ '</label><input class="input-mini" type="text" name="daterangepicker_end" style="width:80%" value="" disabled="disabled" /></div><div><button class="'
				+ this.applyClass
